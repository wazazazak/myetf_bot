...
class EtfPossessionLoadDatabase {
  ...
  CommandLineRunner etfPossessioninitDatabase(EtfPossessionRepository repository) {
    ...
    return args -> {
    	log.info("Preloading " + repository.save(new EtfPossession("1502506769", "160635473367600099", "091180", 35)));
        ...
        log.info("Preloading " + repository.save(new EtfPossession("1502506769", "160635473367600099", "999999", 10000)));
        ...
        log.info("Preloading " + repository.save(new EtfPossession("1351754505", "160657695589800099", "091160", 90)));
